...
export class Migrations1712414693382 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "todos" ADD CONSTRAINT "UQ_55ec0b6954c4006c446aed51ab4" UNIQUE ("coverId")`);
        await queryRunner.query(`ALTER TABLE "todos" ADD CONSTRAINT "FK_55ec0b6954c4006c446aed51ab4" FOREIGN KEY ("coverId") REFERENCES "files"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
